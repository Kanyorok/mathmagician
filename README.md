...
```sh
  - cd my-folder
  - git clone https://github.com/Kanyorok/mathmagician.git
  - cd mathmagician
  - npm i
```
### Install
...
Feel free to check the [issues page](https://github.com/Kanyorok/mathmagician/issues).
...
## 🙏 Acknowledgments <a name="acknowledgements"></a>s
